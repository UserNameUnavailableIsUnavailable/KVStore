...
{
  public:
    FileStream(const std::string &path, Foundation::FileMode mode, ::mode_t permissions, Multiplexer &multiplexer,
               Scheduler &scheduler);
    ...
    static std::shared_ptr<FileStream> Open(const std::string &path, Foundation::FileMode mode, ::mode_t permissions,
    ...
    Foundation::File::Handle native_handle() const noexcept
    {
