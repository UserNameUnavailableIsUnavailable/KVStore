...
public:
    ...
    {
        if (socket_.get_native_handle() == h)
        {
            return;
        }
    ...
    template <typename F>
    auto WithWrite::Foundation::Buffer(F&& f)
    {
        write_offset_ = 0;
    ...
    void PrepareResponse(const Result& result)
    {
        ...
        WithWrite::Foundation::Buffer([&encoded](std::pmr::vector<char>& buffer) {
    ...
    {
        WithWrite::Foundation::Buffer([data](std::pmr::vector<char>& buffer) {
            buffer.assign(data.begin(), data.end());
        });
    }

    void DiscardRead::Foundation::Buffer()
    {
        ClearRead::Foundation::Buffer();
    }
    ...
    template <typename F>
    auto WithConstWrite::Foundation::Buffer(F&& f) const
    {
...
private:
    ...
    template <typename F>
    auto WithRead::Foundation::Buffer(F&& f) const
    {
    ...
    {
        return WithRead::Foundation::Buffer([this](const std::pmr::vector<char>& buffer) {
    ...
    bool ConsumeRead::Foundation::Buffer(std::size_t size)
    {
    ...
    void ClearRead::Foundation::Buffer()
    {
        read_buffer_.clear();
        read_offset_ = 0;
    }
