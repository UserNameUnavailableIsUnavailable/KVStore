...
Foundation::NBIO::Task<std::optional<TransferOffer>> AcceptTransfer(Foundation::NBIO::RDMA_Session &session);
...
// wrote out.
Foundation::NBIO::Task<std::optional<std::uintmax_t>> SendPayload(Foundation::NBIO::RDMA_Session &session,
...
// log.
Foundation::NBIO::Task<std::optional<TransferResult>> ReceivePayload(Foundation::NBIO::RDMA_Session &session,
...
// size of one message.
Foundation::NBIO::Task<std::optional<std::uintmax_t>> SendFile(Foundation::NBIO::RDMA_Session &session,
...
Foundation::NBIO::Task<std::optional<TransferResult>> ReceiveFile(Foundation::NBIO::RDMA_Session &session,
                                                                 const std::filesystem::path &path,
                                                                 std::size_t chunk_size);
...
Foundation::NBIO::Task<std::optional<std::uintmax_t>> SendCommands(Foundation::NBIO::RDMA_Session &session,
                                                                  const TransferOffer &offer,
                                                                  std::uint64_t end_offset, std::uintmax_t size,
...
Foundation::NBIO::Task<std::optional<TransferResult>> ReceiveCommands(Foundation::NBIO::RDMA_Session &session,
                                                                     std::uint64_t offset,
                                                                     const PacketWriter &write,
                                                                     std::size_t chunk_size);
} // namespace KV
